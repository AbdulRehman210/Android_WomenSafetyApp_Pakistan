...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    //share location button
      Button shareLocationButton =  findViewById(R.id.shareLocation);
      ...
      shareLocationButton.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
              ...
              String uri = "I Don't Feel Secure,Here Is My Location https://www.google.com/maps/?q=" + lat+ "," +lng ;
              ...
              sendIntent.putExtra(android.content.Intent.EXTRA_TEXT, uri);
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location)
            {
                if(location != null)
                {
                    ...
                    mMap.addMarker(new MarkerOptions().position(latLng).title("Your Location").icon(BitmapDescriptorFactory.fromResource(R.drawable.person2)));
